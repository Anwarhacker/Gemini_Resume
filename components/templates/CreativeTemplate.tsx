...
export const CreativeTemplate = ({ data }: { data: ResumeData }) => {
    return (
        <div className="h-full flex font-sans">
            {/* Left Sidebar */}
            <aside className="w-[35%] bg-slate-900 text-white p-6 flex flex-col gap-6">
            ...
            <main className="flex-1 p-8 text-slate-800 bg-white">
                {data.summary && (
                    <section className="mb-8">
                        <h3 className="text-lg font-bold uppercase text-slate-900 border-b-2 border-slate-100 pb-2 mb-3">Profile</h3>
                ...
                {data.experience.length > 0 && (
                    <section className="mb-8">
                        <h3 className="text-lg font-bold uppercase text-slate-900 border-b-2 border-slate-100 pb-2 mb-4">Work Experience</h3>
                 ...
                 {data.projects.length > 0 && (
                    <section className="mb-8">
                        <h3 className="text-lg font-bold uppercase text-slate-900 border-b-2 border-slate-100 pb-2 mb-4">Projects</h3>
                ...
                <div className="grid grid-cols-1 gap-8">
                    {data.education.length > 0 && (
                        <section>
                             <h3 className="text-lg font-bold uppercase text-slate-900 border-b-2 border-slate-100 pb-2 mb-4">Education</h3>
                             <div className="space-y-4">
